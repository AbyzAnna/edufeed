      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            className="w-full pl-14 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-purple-500 transition-colors"
          />
        </div>
