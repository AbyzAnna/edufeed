...
import { Plus, Search, Users, UserPlus, Video, Loader2 } from "lucide-react";
...
export default function StudyHubPage() {
  ...
  const activeRooms = filteredRooms.filter((r) => r.isActive && !r.endedAt);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold mb-4">Sign in to Study Together</h2>
          <p className="text-gray-400 mb-6 max-w-md">
            Create or join real-time study rooms to collaborate with others
          </p>
          <button
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-white/60 mb-6 max-w-md">
              {searchQuery
                ...
                : "Create a study room to collaborate with others in real-time video sessions, or join an existing room with a code."}
            </p>
            {!searchQuery && (
              <div className="flex gap-3">
                <Button
